   ...
   function checkAuthorization() {
    ...
    //   alert(res.data[0]['activity_name']);
      ...
      res.data.forEach(element => {
        if(element['activity_name'] === 'rework') {
          if(window.localStorage.getItem('loggedInUserrole') === "admin") {
            // alert(element.admin['READ']);
         
            element.admin['READ']==="Checked" ? setSelectedDIV_state(<Reworkview/>) :setSelectedDIV_state(<NotAuthorizedSection/>);
              ...
              element.operator['READ']==="Checked" ? setSelectedDIV_state(<Reworkview/>) :setSelectedDIV_state(<NotAuthorizedSection/>);
             ...
             element.supervisor['READ']==="Checked" ? setSelectedDIV_state(<Reworkview/>) :setSelectedDIV_state(<NotAuthorizedSection/>);
               ...
               element.masterdata['READ']==="Checked"?setSelectedDIV_state(<Reworkview/>):setSelectedDIV_state(<NotAuthorizedSection/>);
...
export default ReworkAfterLoginCheck;